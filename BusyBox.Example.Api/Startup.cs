...
using BusyBox.AspNetCore.Authentications;
using BusyBox.AspNetCore.Authentications.Jwt.Handler;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BusyBox.Example.Api v1"));
            }
